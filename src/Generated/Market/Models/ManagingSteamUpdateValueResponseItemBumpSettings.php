 ...
 */
class ManagingSteamUpdateValueResponseItemBumpSettings implements JsonSerializable
{
    public function __construct(
        ...
        public readonly mixed $nextAllowedBumpDate = null, // Next Allowed Bump Date
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            nextAllowedBumpDate: $data['nextAllowedBumpDate'] ?? null,
    ...
    public function toArray(): array
    {
        return array_filter([
            ...
            'nextAllowedBumpDate' => $this->nextAllowedBumpDate,
