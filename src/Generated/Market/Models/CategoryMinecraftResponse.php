 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryMinecraftResponseItemsItem[]|null $items Items
 */
class CategoryMinecraftResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryMinecraftResponseItemsItem::fromArray($item), $data['items']) : null,
