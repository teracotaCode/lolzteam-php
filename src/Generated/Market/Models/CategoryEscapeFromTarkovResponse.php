 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryEscapeFromTarkovResponseItemsItem[]|null $items Items
 */
class CategoryEscapeFromTarkovResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryEscapeFromTarkovResponseItemsItem::fromArray($item), $data['items']) : null,
