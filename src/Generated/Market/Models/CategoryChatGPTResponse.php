 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryChatGPTResponseItemsItem[]|null $items Items
 */
class CategoryChatGPTResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryChatGPTResponseItemsItem::fromArray($item), $data['items']) : null,
