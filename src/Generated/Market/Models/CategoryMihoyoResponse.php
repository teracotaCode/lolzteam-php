 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryMihoyoResponseItemsItem[]|null $items Items
 */
class CategoryMihoyoResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryMihoyoResponseItemsItem::fromArray($item), $data['items']) : null,
