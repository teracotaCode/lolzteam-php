 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryUplayResponseItemsItem[]|null $items Items
 */
class CategoryUplayResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryUplayResponseItemsItem::fromArray($item), $data['items']) : null,
