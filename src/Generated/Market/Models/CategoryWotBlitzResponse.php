 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryWotBlitzResponseItemsItem[]|null $items Items
 */
class CategoryWotBlitzResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryWotBlitzResponseItemsItem::fromArray($item), $data['items']) : null,
