 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryWarfaceResponseItemsItem[]|null $items Items
 */
class CategoryWarfaceResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryWarfaceResponseItemsItem::fromArray($item), $data['items']) : null,
