 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryTelegramResponseItemsItem[]|null $items Items
 */
class CategoryTelegramResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryTelegramResponseItemsItem::fromArray($item), $data['items']) : null,
