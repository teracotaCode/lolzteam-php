 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryBattleNetResponseItemsItem[]|null $items Items
 */
class CategoryBattleNetResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryBattleNetResponseItemsItem::fromArray($item), $data['items']) : null,
