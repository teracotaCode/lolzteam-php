 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryBattleNetResponseItemsItemBattlenetTransactionsItem[]|null $battlenetTransactions Battlenet Transactions
 */
class CategoryBattleNetResponseItemsItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly int|null $battlenetItemId = null, // Battlenet
        public readonly string|null $battlenetBalance = null, // Battlenet
        public readonly string|null $battlenetCountry = null, // Battlenet
        public readonly int|null $battlenetLastActivity = null, // Battlenet
        public readonly int|null $battlenetMobile = null, // Battlenet
        public readonly string|null $battlenetBans = null, // Battlenet
        public readonly int|null $battlenetCanChangeTag = null, // Battlenet
        public readonly int|null $battlenetRealIdEnabled = null, // Battlenet
        public readonly int|null $battlenetChangeFullName = null, // Battlenet
        public readonly int|null $battlenetParentControl = null, // Battlenet
        public readonly int|null $battlenetConvertedBalance = null, // Battlenet
        ...
        public readonly \Lolzteam\Generated\Market\Models\CategoryBattleNetResponseItemsItemBumpSettings|null $bumpSettings = null, // Bump Settings
        ...
        public readonly mixed $battlenetGames = null, // Battlenet Games
        public readonly bool|null $hasOverwatch = null, // Has Overwatch
        public readonly array|null $battlenetTransactions = null, // Battlenet Transactions
        ...
        public readonly \Lolzteam\Generated\Market\Models\CategoryBattleNetResponseItemsItemSeller|null $seller = null, // Seller
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            battlenetItemId: $data['battlenet_item_id'] ?? null,
            battlenetBalance: $data['battlenet_balance'] ?? null,
            battlenetCountry: $data['battlenet_country'] ?? null,
            battlenetLastActivity: $data['battlenet_last_activity'] ?? null,
            battlenetMobile: $data['battlenet_mobile'] ?? null,
            battlenetBans: $data['battlenet_bans'] ?? null,
            battlenetCanChangeTag: $data['battlenet_can_change_tag'] ?? null,
            battlenetRealIdEnabled: $data['battlenet_real_id_enabled'] ?? null,
            battlenetChangeFullName: $data['battlenet_change_full_name'] ?? null,
            battlenetParentControl: $data['battlenet_parent_control'] ?? null,
            battlenetConvertedBalance: $data['battlenet_converted_balance'] ?? null,
            ...
            bumpSettings: isset($data['bumpSettings']) && is_array($data['bumpSettings']) && !empty($data['bumpSettings']) ? \Lolzteam\Generated\Market\Models\CategoryBattleNetResponseItemsItemBumpSettings::fromArray($data['bumpSettings']) : null,
            ...
            battlenetGames: $data['battlenetGames'] ?? null,
            hasOverwatch: $data['hasOverwatch'] ?? null,
            battlenetTransactions: isset($data['battlenetTransactions']) && is_array($data['battlenetTransactions']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryBattleNetResponseItemsItemBattlenetTransactionsItem::fromArray($item), $data['battlenetTransactions']) : null,
            ...
            seller: isset($data['seller']) && is_array($data['seller']) && !empty($data['seller']) ? \Lolzteam\Generated\Market\Models\CategoryBattleNetResponseItemsItemSeller::fromArray($data['seller']) : null,
        );
    }
    ...
    public function toArray(): array
    {
        return array_filter([
            ...
            'battlenet_item_id' => $this->battlenetItemId,
            'battlenet_balance' => $this->battlenetBalance,
            'battlenet_country' => $this->battlenetCountry,
            'battlenet_last_activity' => $this->battlenetLastActivity,
            'battlenet_mobile' => $this->battlenetMobile,
            'battlenet_bans' => $this->battlenetBans,
            'battlenet_can_change_tag' => $this->battlenetCanChangeTag,
            'battlenet_real_id_enabled' => $this->battlenetRealIdEnabled,
            'battlenet_change_full_name' => $this->battlenetChangeFullName,
            'battlenet_parent_control' => $this->battlenetParentControl,
            'battlenet_converted_balance' => $this->battlenetConvertedBalance,
            ...
            'battlenetGames' => $this->battlenetGames,
            'hasOverwatch' => $this->hasOverwatch,
            'battlenetTransactions' => $this->battlenetTransactions !== null ? array_map(static fn($item) => $item instanceof \JsonSerializable ? $item->toArray() : $item, $this->battlenetTransactions) : null,
