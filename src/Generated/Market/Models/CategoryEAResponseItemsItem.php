 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryEAResponseItemsItemAccountLinksItem[]|null $accountLinks Account Links
 */
class CategoryEAResponseItemsItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly int|null $eaItemId = null, // Ea
        public readonly int|null $eaId = null, // Ea
        public readonly string|null $eaCountry = null, // Ea
        public readonly \Lolzteam\Generated\Market\Models\CategoryEAResponseItemsItemEaGames|null $eaGames = null, // Ea
        public readonly int|null $eaGameCount = null, // Ea
        public readonly int|null $eaLastActivity = null, // Ea
        public readonly int|null $eaAlLevel = null, // Ea
        public readonly int|null $eaAlRankScore = null, // Ea
        public readonly string|null $eaSubscription = null, // Ea
        public readonly int|null $eaSubscriptionEndDate = null, // Ea
        public readonly string|null $eaUsername = null, // Ea
        public readonly int|null $eaXboxConnected = null, // Ea
        public readonly int|null $eaSteamConnected = null, // Ea
        public readonly int|null $eaPsnConnected = null, // Ea
        public readonly array|null $eaBans = null, // Ea
        public readonly int|null $eaHasBan = null, // Ea
        ...
        public readonly \Lolzteam\Generated\Market\Models\CategoryEAResponseItemsItemBumpSettings|null $bumpSettings = null, // Bump Settings
        ...
        public readonly \Lolzteam\Generated\Market\Models\CategoryEAResponseItemsItemSeller|null $seller = null, // Seller
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            eaItemId: $data['ea_item_id'] ?? null,
            eaId: $data['ea_id'] ?? null,
            eaCountry: $data['ea_country'] ?? null,
            eaGames: isset($data['ea_games']) && is_array($data['ea_games']) && !empty($data['ea_games']) ? \Lolzteam\Generated\Market\Models\CategoryEAResponseItemsItemEaGames::fromArray($data['ea_games']) : null,
            eaGameCount: $data['ea_game_count'] ?? null,
            eaLastActivity: $data['ea_last_activity'] ?? null,
            eaAlLevel: $data['ea_al_level'] ?? null,
            eaAlRankScore: $data['ea_al_rank_score'] ?? null,
            eaSubscription: $data['ea_subscription'] ?? null,
            eaSubscriptionEndDate: $data['ea_subscription_end_date'] ?? null,
            eaUsername: $data['ea_username'] ?? null,
            eaXboxConnected: $data['ea_xbox_connected'] ?? null,
            eaSteamConnected: $data['ea_steam_connected'] ?? null,
            eaPsnConnected: $data['ea_psn_connected'] ?? null,
            eaBans: $data['ea_bans'] ?? null,
            eaHasBan: $data['ea_has_ban'] ?? null,
            ...
            bumpSettings: isset($data['bumpSettings']) && is_array($data['bumpSettings']) && !empty($data['bumpSettings']) ? \Lolzteam\Generated\Market\Models\CategoryEAResponseItemsItemBumpSettings::fromArray($data['bumpSettings']) : null,
            ...
            accountLinks: isset($data['accountLinks']) && is_array($data['accountLinks']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryEAResponseItemsItemAccountLinksItem::fromArray($item), $data['accountLinks']) : null,
            ...
            seller: isset($data['seller']) && is_array($data['seller']) && !empty($data['seller']) ? \Lolzteam\Generated\Market\Models\CategoryEAResponseItemsItemSeller::fromArray($data['seller']) : null,
        );
    }
    ...
    public function toArray(): array
    {
        return array_filter([
            ...
            'ea_item_id' => $this->eaItemId,
            'ea_id' => $this->eaId,
            'ea_country' => $this->eaCountry,
            'ea_games' => $this->eaGames?->toArray(),
            'ea_game_count' => $this->eaGameCount,
            'ea_last_activity' => $this->eaLastActivity,
            'ea_al_level' => $this->eaAlLevel,
            'ea_al_rank_score' => $this->eaAlRankScore,
            'ea_subscription' => $this->eaSubscription,
            'ea_subscription_end_date' => $this->eaSubscriptionEndDate,
            'ea_username' => $this->eaUsername,
            'ea_xbox_connected' => $this->eaXboxConnected,
            'ea_steam_connected' => $this->eaSteamConnected,
            'ea_psn_connected' => $this->eaPsnConnected,
            'ea_bans' => $this->eaBans,
            'ea_has_ban' => $this->eaHasBan,
