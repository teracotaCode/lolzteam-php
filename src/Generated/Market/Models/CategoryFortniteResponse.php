 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryFortniteResponseItemsItem[]|null $items Items
 */
class CategoryFortniteResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryFortniteResponseItemsItem::fromArray($item), $data['items']) : null,
