 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategorySupercellResponseItemsItem[]|null $items Items
 */
class CategorySupercellResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategorySupercellResponseItemsItem::fromArray($item), $data['items']) : null,
