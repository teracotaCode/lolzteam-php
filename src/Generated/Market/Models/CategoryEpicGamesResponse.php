 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryEpicGamesResponseItemsItem[]|null $items Items
 */
class CategoryEpicGamesResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryEpicGamesResponseItemsItem::fromArray($item), $data['items']) : null,
