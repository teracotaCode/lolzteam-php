 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryRobloxResponseItemsItem[]|null $items Items
 */
class CategoryRobloxResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryRobloxResponseItemsItem::fromArray($item), $data['items']) : null,
