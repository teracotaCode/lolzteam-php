 ...
 * @property-read \Lolzteam\Generated\Market\Models\ProfileGetResponseUserBalancesItem[]|null $balances Balances
 * @property-read \Lolzteam\Generated\Market\Models\ProfileGetResponseUserPublicTagsItem[]|null $publicTags Public
 */
class ProfileGetResponseUser implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Market\Models\ProfileGetResponseUserCustomFields|null $customFields = null, // Custom
        public readonly string|null $customTitle = null, // Custom
        public readonly int|null $deposit = null, // Deposit
        public readonly \Lolzteam\Generated\Market\Models\ProfileGetResponseUserDob|null $dob = null, // Dob
        ...
        public readonly \Lolzteam\Generated\Market\Models\ProfileGetResponseUserRendered|null $rendered = null, // Rendered
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            balances: isset($data['balances']) && is_array($data['balances']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\ProfileGetResponseUserBalancesItem::fromArray($item), $data['balances']) : null,
            ...
            customFields: isset($data['custom_fields']) && is_array($data['custom_fields']) && !empty($data['custom_fields']) ? \Lolzteam\Generated\Market\Models\ProfileGetResponseUserCustomFields::fromArray($data['custom_fields']) : null,
            customTitle: $data['custom_title'] ?? null,
            deposit: $data['deposit'] ?? null,
            dob: isset($data['dob']) && is_array($data['dob']) && !empty($data['dob']) ? \Lolzteam\Generated\Market\Models\ProfileGetResponseUserDob::fromArray($data['dob']) : null,
            ...
            publicTags: isset($data['public_tags']) && is_array($data['public_tags']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\ProfileGetResponseUserPublicTagsItem::fromArray($item), $data['public_tags']) : null,
            registerDate: $data['register_date'] ?? null,
            rendered: isset($data['rendered']) && is_array($data['rendered']) && !empty($data['rendered']) ? \Lolzteam\Generated\Market\Models\ProfileGetResponseUserRendered::fromArray($data['rendered']) : null,
