 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategorySteamResponseItemsItem[]|null $items Items
 */
class CategorySteamResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategorySteamResponseItemsItem::fromArray($item), $data['items']) : null,
