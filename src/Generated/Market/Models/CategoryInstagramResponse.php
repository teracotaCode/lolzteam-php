 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryInstagramResponseItemsItem[]|null $items Items
 */
class CategoryInstagramResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryInstagramResponseItemsItem::fromArray($item), $data['items']) : null,
