 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryHytaleResponseItemsItem[]|null $items Items
 */
class CategoryHytaleResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryHytaleResponseItemsItem::fromArray($item), $data['items']) : null,
