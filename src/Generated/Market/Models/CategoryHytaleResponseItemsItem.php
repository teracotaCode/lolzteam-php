 ...
 */
class CategoryHytaleResponseItemsItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly int|null $autoBumpPeriod = null, // Auto
        public readonly int|null $rubPrice = null, // Rub
        public readonly bool|null $discount = null, // Discount
        public readonly int|null $hytaleItemId = null, // Hytale
        public readonly int|null $hytaleProfiles = null, // Hytale
        public readonly string|null $hytaleEdition = null, // Hytale
        ...
        public readonly \Lolzteam\Generated\Market\Models\CategoryHytaleResponseItemsItemCategory|null $category = null, // Category
        public readonly mixed $guarantee = null, // Guarantee
        public readonly bool|null $canViewLoginData = null, // Can View Login Data
        public readonly bool|null $canViewTempEmail = null, // Can View Temp Email
        ...
        public readonly bool|null $canManagePublicTag = null, // Can Manage Public Tag
        public readonly bool|null $canViewEmailLoginData = null, // Can View Email Login Data
        public readonly \Lolzteam\Generated\Market\Models\CategoryHytaleResponseItemsItemCopyFormatData|null $copyFormatData = null, // Copy Format Data
        ...
        public readonly string|null $canNotBumpItemReason = null, // Can Not Bump Item Reason
        public readonly mixed $buyer = null, // Buyer
        ...
        public readonly mixed $publicTag = null, // Public
        ...
        public readonly \Lolzteam\Generated\Market\Models\CategoryHytaleResponseItemsItemSeller|null $seller = null, // Seller
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            autoBumpPeriod: $data['auto_bump_period'] ?? null,
            rubPrice: $data['rub_price'] ?? null,
            discount: $data['discount'] ?? null,
            hytaleItemId: $data['hytale_item_id'] ?? null,
            hytaleProfiles: $data['hytale_profiles'] ?? null,
            hytaleEdition: $data['hytale_edition'] ?? null,
            ...
            category: isset($data['category']) && is_array($data['category']) && !empty($data['category']) ? \Lolzteam\Generated\Market\Models\CategoryHytaleResponseItemsItemCategory::fromArray($data['category']) : null,
            guarantee: $data['guarantee'] ?? null,
            canViewLoginData: $data['canViewLoginData'] ?? null,
            canViewTempEmail: $data['canViewTempEmail'] ?? null,
            ...
            canManagePublicTag: $data['canManagePublicTag'] ?? null,
            canViewEmailLoginData: $data['canViewEmailLoginData'] ?? null,
            copyFormatData: isset($data['copyFormatData']) && is_array($data['copyFormatData']) && !empty($data['copyFormatData']) ? \Lolzteam\Generated\Market\Models\CategoryHytaleResponseItemsItemCopyFormatData::fromArray($data['copyFormatData']) : null,
            ...
            canNotBumpItemReason: $data['canNotBumpItemReason'] ?? null,
            ...
            tags: $data['tags'] ?? null,
            publicTag: $data['public_tag'] ?? null,
            ...
            seller: isset($data['seller']) && is_array($data['seller']) && !empty($data['seller']) ? \Lolzteam\Generated\Market\Models\CategoryHytaleResponseItemsItemSeller::fromArray($data['seller']) : null,
        );
    }
    ...
    public function toArray(): array
    {
        return array_filter([
            ...
            'auto_bump_period' => $this->autoBumpPeriod,
            'rub_price' => $this->rubPrice,
            'discount' => $this->discount,
            'hytale_item_id' => $this->hytaleItemId,
            'hytale_profiles' => $this->hytaleProfiles,
            'hytale_edition' => $this->hytaleEdition,
            ...
            'canNotBumpItemReason' => $this->canNotBumpItemReason,
            'buyer' => $this->buyer,
