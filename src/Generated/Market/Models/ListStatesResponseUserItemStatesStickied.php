 ...
 */
class ListStatesResponseUserItemStatesStickied implements JsonSerializable
{
    public function __construct(
        ...
        public readonly int|null $stickyLimit = null, // Sticky Limit
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            stickyLimit: $data['stickyLimit'] ?? null,
        );
    }
