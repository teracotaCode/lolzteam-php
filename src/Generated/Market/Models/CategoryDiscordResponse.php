 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryDiscordResponseItemsItem[]|null $items Items
 */
class CategoryDiscordResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryDiscordResponseItemsItem::fromArray($item), $data['items']) : null,
