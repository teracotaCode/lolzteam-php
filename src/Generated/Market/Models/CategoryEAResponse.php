 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryEAResponseItemsItem[]|null $items Items
 */
class CategoryEAResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryEAResponseItemsItem::fromArray($item), $data['items']) : null,
