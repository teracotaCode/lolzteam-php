 ...
 */
class CategoryVpnResponseItemsItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly int|null $vpnItemId = null, // Vpn
        public readonly string|null $vpnService = null, // Vpn
        public readonly int|null $vpnExpireDate = null, // Vpn
        public readonly int|null $vpnRenewable = null, // Vpn
        ...
        public readonly \Lolzteam\Generated\Market\Models\CategoryVpnResponseItemsItemBumpSettings|null $bumpSettings = null, // Bump Settings
        ...
        public readonly string|null $vpnProductTitle = null, // Vpn Product Title
        ...
        public readonly \Lolzteam\Generated\Market\Models\CategoryVpnResponseItemsItemSeller|null $seller = null, // Seller
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            vpnItemId: $data['vpn_item_id'] ?? null,
            vpnService: $data['vpn_service'] ?? null,
            vpnExpireDate: $data['vpn_expire_date'] ?? null,
            vpnRenewable: $data['vpn_renewable'] ?? null,
            ...
            bumpSettings: isset($data['bumpSettings']) && is_array($data['bumpSettings']) && !empty($data['bumpSettings']) ? \Lolzteam\Generated\Market\Models\CategoryVpnResponseItemsItemBumpSettings::fromArray($data['bumpSettings']) : null,
            ...
            vpnProductTitle: $data['vpnProductTitle'] ?? null,
            ...
            seller: isset($data['seller']) && is_array($data['seller']) && !empty($data['seller']) ? \Lolzteam\Generated\Market\Models\CategoryVpnResponseItemsItemSeller::fromArray($data['seller']) : null,
        );
    }
    ...
    public function toArray(): array
    {
        return array_filter([
            ...
            'vpn_item_id' => $this->vpnItemId,
            'vpn_service' => $this->vpnService,
            'vpn_expire_date' => $this->vpnExpireDate,
            'vpn_renewable' => $this->vpnRenewable,
            ...
            'vpnProductTitle' => $this->vpnProductTitle,
