 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryVpnResponseItemsItem[]|null $items Items
 */
class CategoryVpnResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryVpnResponseItemsItem::fromArray($item), $data['items']) : null,
