 ...
 * @property-read \Lolzteam\Generated\Market\Models\ManagingGetResponseItemAccountLinksItem[]|null $accountLinks Account Links
 * @property-read \Lolzteam\Generated\Market\Models\ManagingGetResponseItemExtraPricesItem[]|null $extraPrices Extra Prices
 */
class ManagingGetResponseItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Market\Models\ManagingGetResponseItemLoginData|null $loginData = null, // Login Data
        public readonly bool|null $canViewEmailLoginData = null, // Can View Email Login Data
        public readonly \Lolzteam\Generated\Market\Models\ManagingGetResponseItemCopyFormatData|null $copyFormatData = null, // Copy Format Data
        ...
        public readonly \Lolzteam\Generated\Market\Models\ManagingGetResponseItemBuyer|null $buyer = null, // Buyer
        ...
        public readonly \Lolzteam\Generated\Market\Models\ManagingGetResponseItemCustomFields|null $customFields = null, // Custom Fields
        ...
        public readonly \Lolzteam\Generated\Market\Models\ManagingGetResponseItemBumpSettings|null $bumpSettings = null, // Bump Settings
        ...
        public readonly int|bool|null $autoBuyPrice = null, // Auto Buy Price
        ...
        public readonly \Lolzteam\Generated\Market\Models\ManagingGetResponseItemSeller|null $seller = null, // Seller
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            loginData: isset($data['loginData']) && is_array($data['loginData']) && !empty($data['loginData']) ? \Lolzteam\Generated\Market\Models\ManagingGetResponseItemLoginData::fromArray($data['loginData']) : null,
            canViewEmailLoginData: $data['canViewEmailLoginData'] ?? null,
            copyFormatData: isset($data['copyFormatData']) && is_array($data['copyFormatData']) && !empty($data['copyFormatData']) ? \Lolzteam\Generated\Market\Models\ManagingGetResponseItemCopyFormatData::fromArray($data['copyFormatData']) : null,
            showGetEmailCodeButton: $data['showGetEmailCodeButton'] ?? null,
            getEmailCodeDisplayLogin: $data['getEmailCodeDisplayLogin'] ?? null,
            buyer: isset($data['buyer']) && is_array($data['buyer']) && !empty($data['buyer']) ? \Lolzteam\Generated\Market\Models\ManagingGetResponseItemBuyer::fromArray($data['buyer']) : null,
            ...
            accountLinks: isset($data['accountLinks']) && is_array($data['accountLinks']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\ManagingGetResponseItemAccountLinksItem::fromArray($item), $data['accountLinks']) : null,
            ...
            tags: $data['tags'] ?? null,
            customFields: isset($data['customFields']) && is_array($data['customFields']) && !empty($data['customFields']) ? \Lolzteam\Generated\Market\Models\ManagingGetResponseItemCustomFields::fromArray($data['customFields']) : null,
            ...
            extraPrices: isset($data['extraPrices']) && is_array($data['extraPrices']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\ManagingGetResponseItemExtraPricesItem::fromArray($item), $data['extraPrices']) : null,
            canViewAccountLoginAndTempEmail: $data['canViewAccountLoginAndTempEmail'] ?? null,
            bumpSettings: isset($data['bumpSettings']) && is_array($data['bumpSettings']) && !empty($data['bumpSettings']) ? \Lolzteam\Generated\Market\Models\ManagingGetResponseItemBumpSettings::fromArray($data['bumpSettings']) : null,
            ...
            seller: isset($data['seller']) && is_array($data['seller']) && !empty($data['seller']) ? \Lolzteam\Generated\Market\Models\ManagingGetResponseItemSeller::fromArray($data['seller']) : null,
        );
    }
