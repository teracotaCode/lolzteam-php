 ...
 */
class ManagingSteamUpdateValueResponseItemSeller implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Market\Models\ManagingSteamUpdateValueResponseItemSellerContacts|null $contacts = null, // Contacts
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            contacts: isset($data['contacts']) && is_array($data['contacts']) && !empty($data['contacts']) ? \Lolzteam\Generated\Market\Models\ManagingSteamUpdateValueResponseItemSellerContacts::fromArray($data['contacts']) : null,
        );
    }
