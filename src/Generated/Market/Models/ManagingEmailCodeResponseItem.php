 ...
 * @property-read \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemAccountLinksItem[]|null $accountLinks Account Links
 * @property-read \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemExtraPricesItem[]|null $extraPrices Extra Prices
 */
class ManagingEmailCodeResponseItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemLoginData|null $loginData = null, // Login Data
        public readonly bool|null $canViewEmailLoginData = null, // Can View Email Login Data
        public readonly \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemCopyFormatData|null $copyFormatData = null, // Copy Format Data
        ...
        public readonly \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemBuyer|null $buyer = null, // Buyer
        ...
        public readonly \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemCustomFields|null $customFields = null, // Custom Fields
        ...
        public readonly \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemBumpSettings|null $bumpSettings = null, // Bump Settings
        ...
        public readonly \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemSeller|null $seller = null, // Seller
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            loginData: isset($data['loginData']) && is_array($data['loginData']) && !empty($data['loginData']) ? \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemLoginData::fromArray($data['loginData']) : null,
            canViewEmailLoginData: $data['canViewEmailLoginData'] ?? null,
            copyFormatData: isset($data['copyFormatData']) && is_array($data['copyFormatData']) && !empty($data['copyFormatData']) ? \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemCopyFormatData::fromArray($data['copyFormatData']) : null,
            showGetEmailCodeButton: $data['showGetEmailCodeButton'] ?? null,
            getEmailCodeDisplayLogin: $data['getEmailCodeDisplayLogin'] ?? null,
            buyer: isset($data['buyer']) && is_array($data['buyer']) && !empty($data['buyer']) ? \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemBuyer::fromArray($data['buyer']) : null,
            ...
            accountLinks: isset($data['accountLinks']) && is_array($data['accountLinks']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemAccountLinksItem::fromArray($item), $data['accountLinks']) : null,
            ...
            tags: $data['tags'] ?? null,
            customFields: isset($data['customFields']) && is_array($data['customFields']) && !empty($data['customFields']) ? \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemCustomFields::fromArray($data['customFields']) : null,
            ...
            extraPrices: isset($data['extraPrices']) && is_array($data['extraPrices']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemExtraPricesItem::fromArray($item), $data['extraPrices']) : null,
            canViewAccountLoginAndTempEmail: $data['canViewAccountLoginAndTempEmail'] ?? null,
            bumpSettings: isset($data['bumpSettings']) && is_array($data['bumpSettings']) && !empty($data['bumpSettings']) ? \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemBumpSettings::fromArray($data['bumpSettings']) : null,
            ...
            seller: isset($data['seller']) && is_array($data['seller']) && !empty($data['seller']) ? \Lolzteam\Generated\Market\Models\ManagingEmailCodeResponseItemSeller::fromArray($data['seller']) : null,
        );
    }
