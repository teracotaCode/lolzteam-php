 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryRiotResponseItemsItem[]|null $items Items
 */
class CategoryRiotResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryRiotResponseItemsItem::fromArray($item), $data['items']) : null,
