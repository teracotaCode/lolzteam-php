 ...
 * @property-read \Lolzteam\Generated\Market\Models\CategoryTikTokResponseItemsItem[]|null $items Items
 */
class CategoryTikTokResponse implements JsonSerializable
{
    ...
    {
        return new static(
            items: isset($data['items']) && is_array($data['items']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Market\Models\CategoryTikTokResponseItemsItem::fromArray($item), $data['items']) : null,
