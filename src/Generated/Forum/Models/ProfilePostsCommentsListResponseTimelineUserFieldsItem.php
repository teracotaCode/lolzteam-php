 ...
 * @property-read \Lolzteam\Generated\Forum\Models\ProfilePostsCommentsListResponseTimelineUserFieldsItemChoicesItem[]|null $choices Choices
 */
class ProfilePostsCommentsListResponseTimelineUserFieldsItem implements JsonSerializable
{
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            choices: isset($data['choices']) && is_array($data['choices']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\ProfilePostsCommentsListResponseTimelineUserFieldsItemChoicesItem::fromArray($item), $data['choices']) : null,
