 ...
 */
class ChatboxIndexResponseIgnoreItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ChatboxIndexResponseIgnoreItemRendered|null $rendered = null, // Rendered
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            rendered: isset($data['rendered']) && is_array($data['rendered']) && !empty($data['rendered']) ? \Lolzteam\Generated\Forum\Models\ChatboxIndexResponseIgnoreItemRendered::fromArray($data['rendered']) : null,
