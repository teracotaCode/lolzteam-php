 ...
 * @property-read \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemFieldsItemChoicesItem[]|null $choices Choices
 */
class UsersListResponseUsersItemFieldsItem implements JsonSerializable
{
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            choices: isset($data['choices']) && is_array($data['choices']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemFieldsItemChoicesItem::fromArray($item), $data['choices']) : null,
