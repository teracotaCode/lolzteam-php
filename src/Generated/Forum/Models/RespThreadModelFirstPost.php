 ...
 */
class RespThreadModelFirstPost implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\RespThreadModelFirstPostLinks|null $links = null, // Links
        public readonly \Lolzteam\Generated\Forum\Models\RespThreadModelFirstPostPermissions|null $permissions = null, // Permissions
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\RespThreadModelFirstPostLinks::fromArray($data['links']) : null,
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\RespThreadModelFirstPostPermissions::fromArray($data['permissions']) : null,
