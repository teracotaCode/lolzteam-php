 ...
 * @property-read \Lolzteam\Generated\Forum\Models\ConversationsCreateResponseConversationRecipientsItem[]|null $recipients Recipients
 */
class ConversationsCreateResponseConversation implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ConversationsCreateResponseConversationPermissions|null $permissions = null, // Permissions
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ConversationsCreateResponseConversationRecipient|null $recipient = null, // Recipient
        public readonly array|null $recipients = null, // Recipients
        public readonly \Lolzteam\Generated\Forum\Models\ConversationsCreateResponseConversationLinks|null $links = null, // Links
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\ConversationsCreateResponseConversationPermissions::fromArray($data['permissions']) : null,
            ...
            recipient: isset($data['recipient']) && is_array($data['recipient']) && !empty($data['recipient']) ? \Lolzteam\Generated\Forum\Models\ConversationsCreateResponseConversationRecipient::fromArray($data['recipient']) : null,
            recipients: isset($data['recipients']) && is_array($data['recipients']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\ConversationsCreateResponseConversationRecipientsItem::fromArray($item), $data['recipients']) : null,
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\ConversationsCreateResponseConversationLinks::fromArray($data['links']) : null,
        );
    }
