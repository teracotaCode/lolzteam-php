 ...
 */
class ThreadsListResponseThreadsItemPermissions implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsListResponseThreadsItemPermissionsBump|null $bump = null, // Bump
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            bump: isset($data['bump']) && is_array($data['bump']) && !empty($data['bump']) ? \Lolzteam\Generated\Forum\Models\ThreadsListResponseThreadsItemPermissionsBump::fromArray($data['bump']) : null,
        );
    }
