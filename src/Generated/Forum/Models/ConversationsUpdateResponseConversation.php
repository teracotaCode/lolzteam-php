 ...
 * @property-read \Lolzteam\Generated\Forum\Models\ConversationsUpdateResponseConversationRecipientsItem[]|null $recipients Recipients
 */
class ConversationsUpdateResponseConversation implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ConversationsUpdateResponseConversationPermissions|null $permissions = null, // Permissions
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ConversationsUpdateResponseConversationRecipient|null $recipient = null, // Recipient
        public readonly array|null $recipients = null, // Recipients
        public readonly \Lolzteam\Generated\Forum\Models\ConversationsUpdateResponseConversationLinks|null $links = null, // Links
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\ConversationsUpdateResponseConversationPermissions::fromArray($data['permissions']) : null,
            ...
            recipient: isset($data['recipient']) && is_array($data['recipient']) && !empty($data['recipient']) ? \Lolzteam\Generated\Forum\Models\ConversationsUpdateResponseConversationRecipient::fromArray($data['recipient']) : null,
            recipients: isset($data['recipients']) && is_array($data['recipients']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\ConversationsUpdateResponseConversationRecipientsItem::fromArray($item), $data['recipients']) : null,
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\ConversationsUpdateResponseConversationLinks::fromArray($data['links']) : null,
        );
    }
