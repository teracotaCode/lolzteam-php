 ...
 */
class PostsListResponsePostsItemPermissions implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\PostsListResponsePostsItemPermissionsBump|null $bump = null, // Bump
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            bump: isset($data['bump']) && is_array($data['bump']) && !empty($data['bump']) ? \Lolzteam\Generated\Forum\Models\PostsListResponsePostsItemPermissionsBump::fromArray($data['bump']) : null,
        );
    }
