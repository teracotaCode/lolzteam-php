 ...
 */
class ThreadsCreateContestResponseThread implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsCreateContestResponseThreadFirstPost|null $firstPost = null, // First
        public readonly array|null $threadPrefixes = null, // Thread
        public readonly array|null $threadTags = null, // Thread
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsCreateContestResponseThreadLinks|null $links = null, // Links
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsCreateContestResponseThreadPermissions|null $permissions = null, // Permissions
        public readonly string|null $nodeTitle = null, // Node
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsCreateContestResponseThreadRestrictions|null $restrictions = null, // Restrictions
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsCreateContestResponseThreadLastPost|null $lastPost = null, // Last
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsCreateContestResponseThreadContest|null $contest = null,
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            firstPost: isset($data['first_post']) && is_array($data['first_post']) && !empty($data['first_post']) ? \Lolzteam\Generated\Forum\Models\ThreadsCreateContestResponseThreadFirstPost::fromArray($data['first_post']) : null,
            threadPrefixes: $data['thread_prefixes'] ?? null,
            threadTags: $data['thread_tags'] ?? null,
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\ThreadsCreateContestResponseThreadLinks::fromArray($data['links']) : null,
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\ThreadsCreateContestResponseThreadPermissions::fromArray($data['permissions']) : null,
            nodeTitle: $data['node_title'] ?? null,
            restrictions: isset($data['restrictions']) && is_array($data['restrictions']) && !empty($data['restrictions']) ? \Lolzteam\Generated\Forum\Models\ThreadsCreateContestResponseThreadRestrictions::fromArray($data['restrictions']) : null,
            lastPost: isset($data['last_post']) && is_array($data['last_post']) && !empty($data['last_post']) ? \Lolzteam\Generated\Forum\Models\ThreadsCreateContestResponseThreadLastPost::fromArray($data['last_post']) : null,
            contest: isset($data['contest']) && is_array($data['contest']) && !empty($data['contest']) ? \Lolzteam\Generated\Forum\Models\ThreadsCreateContestResponseThreadContest::fromArray($data['contest']) : null,
        );
    }
