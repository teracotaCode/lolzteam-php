 ...
 * @property-read \Lolzteam\Generated\Forum\Models\UsersContentsResponseDataItemLikeUsersItem[]|null $likeUsers Like
 */
class UsersContentsResponseDataItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\UsersContentsResponseDataItemLinks|null $links = null, // Links
        public readonly \Lolzteam\Generated\Forum\Models\UsersContentsResponseDataItemPermissions|null $permissions = null, // Permissions
        public readonly \Lolzteam\Generated\Forum\Models\UsersContentsResponseDataItemThread|null $thread = null, // Thread
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            likeUsers: isset($data['like_users']) && is_array($data['like_users']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\UsersContentsResponseDataItemLikeUsersItem::fromArray($item), $data['like_users']) : null,
            ...
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\UsersContentsResponseDataItemLinks::fromArray($data['links']) : null,
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\UsersContentsResponseDataItemPermissions::fromArray($data['permissions']) : null,
            thread: isset($data['thread']) && is_array($data['thread']) && !empty($data['thread']) ? \Lolzteam\Generated\Forum\Models\UsersContentsResponseDataItemThread::fromArray($data['thread']) : null,
        );
    }
