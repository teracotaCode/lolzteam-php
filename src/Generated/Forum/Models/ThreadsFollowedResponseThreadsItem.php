 ...
 */
class ThreadsFollowedResponseThreadsItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsFollowedResponseThreadsItemFirstPost|null $firstPost = null, // First
        public readonly array|null $threadPrefixes = null, // Thread
        public readonly array|null $threadTags = null, // Thread
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsFollowedResponseThreadsItemLinks|null $links = null, // Links
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsFollowedResponseThreadsItemPermissions|null $permissions = null, // Permissions
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsFollowedResponseThreadsItemForum|null $forum = null, // Forum
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsFollowedResponseThreadsItemFollow|null $follow = null, // Follow
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            firstPost: isset($data['first_post']) && is_array($data['first_post']) && !empty($data['first_post']) ? \Lolzteam\Generated\Forum\Models\ThreadsFollowedResponseThreadsItemFirstPost::fromArray($data['first_post']) : null,
            threadPrefixes: $data['thread_prefixes'] ?? null,
            threadTags: $data['thread_tags'] ?? null,
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\ThreadsFollowedResponseThreadsItemLinks::fromArray($data['links']) : null,
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\ThreadsFollowedResponseThreadsItemPermissions::fromArray($data['permissions']) : null,
            forum: isset($data['forum']) && is_array($data['forum']) && !empty($data['forum']) ? \Lolzteam\Generated\Forum\Models\ThreadsFollowedResponseThreadsItemForum::fromArray($data['forum']) : null,
            follow: isset($data['follow']) && is_array($data['follow']) && !empty($data['follow']) ? \Lolzteam\Generated\Forum\Models\ThreadsFollowedResponseThreadsItemFollow::fromArray($data['follow']) : null,
        );
    }
