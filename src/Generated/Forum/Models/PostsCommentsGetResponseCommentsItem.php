 ...
 */
class PostsCommentsGetResponseCommentsItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly int|null $postCommentCreateDate = null, // Post
        ...
        public readonly \Lolzteam\Generated\Forum\Models\PostsCommentsGetResponseCommentsItemLinks|null $links = null, // Links
        public readonly \Lolzteam\Generated\Forum\Models\PostsCommentsGetResponseCommentsItemPermissions|null $permissions = null, // Permissions
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            postCommentCreateDate: $data['post_comment_create_date'] ?? null,
            ...
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\PostsCommentsGetResponseCommentsItemLinks::fromArray($data['links']) : null,
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\PostsCommentsGetResponseCommentsItemPermissions::fromArray($data['permissions']) : null,
        );
    }
    ...
    public function toArray(): array
    {
        return array_filter([
            ...
            'post_comment_create_date' => $this->postCommentCreateDate,
