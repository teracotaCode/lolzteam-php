 ...
 * @property-read \Lolzteam\Generated\Forum\Models\UsersContentsResponseUserFieldsItemChoicesItem[]|null $choices Choices
 */
class UsersContentsResponseUserFieldsItem implements JsonSerializable
{
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            choices: isset($data['choices']) && is_array($data['choices']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\UsersContentsResponseUserFieldsItemChoicesItem::fromArray($item), $data['choices']) : null,
