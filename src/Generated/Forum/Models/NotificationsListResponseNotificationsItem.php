 ...
 */
class NotificationsListResponseNotificationsItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\NotificationsListResponseNotificationsItemLinks|null $links = null, // Links
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\NotificationsListResponseNotificationsItemLinks::fromArray($data['links']) : null,
