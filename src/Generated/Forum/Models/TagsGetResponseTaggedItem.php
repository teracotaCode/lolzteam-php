 ...
 * @property-read \Lolzteam\Generated\Forum\Models\TagsGetResponseTaggedItemThreadPrefixesItem[]|null $threadPrefixes Thread
 */
class TagsGetResponseTaggedItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\TagsGetResponseTaggedItemFirstPost|null $firstPost = null, // First
        public readonly array|null $threadPrefixes = null, // Thread
        public readonly array|null $threadTags = null, // Thread
        public readonly \Lolzteam\Generated\Forum\Models\TagsGetResponseTaggedItemLinks|null $links = null, // Links
        public readonly \Lolzteam\Generated\Forum\Models\TagsGetResponseTaggedItemPermissions|null $permissions = null, // Permissions
        public readonly \Lolzteam\Generated\Forum\Models\TagsGetResponseTaggedItemForum|null $forum = null, // Forum
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            firstPost: isset($data['first_post']) && is_array($data['first_post']) && !empty($data['first_post']) ? \Lolzteam\Generated\Forum\Models\TagsGetResponseTaggedItemFirstPost::fromArray($data['first_post']) : null,
            threadPrefixes: isset($data['thread_prefixes']) && is_array($data['thread_prefixes']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\TagsGetResponseTaggedItemThreadPrefixesItem::fromArray($item), $data['thread_prefixes']) : null,
            threadTags: $data['thread_tags'] ?? null,
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\TagsGetResponseTaggedItemLinks::fromArray($data['links']) : null,
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\TagsGetResponseTaggedItemPermissions::fromArray($data['permissions']) : null,
            forum: isset($data['forum']) && is_array($data['forum']) && !empty($data['forum']) ? \Lolzteam\Generated\Forum\Models\TagsGetResponseTaggedItemForum::fromArray($data['forum']) : null,
        );
    }
    ...
    public function toArray(): array
    {
        return array_filter([
            ...
            'thread_prefixes' => $this->threadPrefixes !== null ? array_map(static fn($item) => $item instanceof \JsonSerializable ? $item->toArray() : $item, $this->threadPrefixes) : null,
