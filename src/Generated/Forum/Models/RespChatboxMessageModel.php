 ...
 */
class RespChatboxMessageModel implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\RespChatboxMessageModelRoom|null $room = null, // Room
        public readonly \Lolzteam\Generated\Forum\Models\RespChatboxMessageModelUser|null $user = null, // User
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            room: isset($data['room']) && is_array($data['room']) && !empty($data['room']) ? \Lolzteam\Generated\Forum\Models\RespChatboxMessageModelRoom::fromArray($data['room']) : null,
            user: isset($data['user']) && is_array($data['user']) && !empty($data['user']) ? \Lolzteam\Generated\Forum\Models\RespChatboxMessageModelUser::fromArray($data['user']) : null,
        );
    }
