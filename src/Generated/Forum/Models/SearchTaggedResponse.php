 ...
 * @property-read \Lolzteam\Generated\Forum\Models\SearchTaggedResponseDataItem[]|null $data Data
 */
class SearchTaggedResponse implements JsonSerializable
{
    ...
    {
        return new static(
            data: isset($data['data']) && is_array($data['data']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\SearchTaggedResponseDataItem::fromArray($item), $data['data']) : null,
