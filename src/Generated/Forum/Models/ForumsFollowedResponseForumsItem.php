 ...
 * @property-read \Lolzteam\Generated\Forum\Models\ForumsFollowedResponseForumsItemForumPrefixesItem[]|null $forumPrefixes Forum
 */
class ForumsFollowedResponseForumsItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ForumsFollowedResponseForumsItemLinks|null $links = null, // Links
        public readonly \Lolzteam\Generated\Forum\Models\ForumsFollowedResponseForumsItemPermissions|null $permissions = null, // Permissions
        public readonly bool|null $forumIsFollowed = null, // Forum
        public readonly \Lolzteam\Generated\Forum\Models\ForumsFollowedResponseForumsItemFollow|null $follow = null, // Follow
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            forumPrefixes: isset($data['forum_prefixes']) && is_array($data['forum_prefixes']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\ForumsFollowedResponseForumsItemForumPrefixesItem::fromArray($item), $data['forum_prefixes']) : null,
            threadDefaultPrefixId: $data['thread_default_prefix_id'] ?? null,
            threadPrefixIsRequired: $data['thread_prefix_is_required'] ?? null,
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\ForumsFollowedResponseForumsItemLinks::fromArray($data['links']) : null,
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\ForumsFollowedResponseForumsItemPermissions::fromArray($data['permissions']) : null,
            forumIsFollowed: $data['forum_is_followed'] ?? null,
            follow: isset($data['follow']) && is_array($data['follow']) && !empty($data['follow']) ? \Lolzteam\Generated\Forum\Models\ForumsFollowedResponseForumsItemFollow::fromArray($data['follow']) : null,
        );
    }
