 ...
 */
class ProfilePostsListResponseProfilePostsItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ProfilePostsListResponseProfilePostsItemLinks|null $links = null, // Links
        public readonly \Lolzteam\Generated\Forum\Models\ProfilePostsListResponseProfilePostsItemPermissions|null $permissions = null, // Permissions
        public readonly \Lolzteam\Generated\Forum\Models\ProfilePostsListResponseProfilePostsItemTimelineUser|null $timelineUser = null,
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\ProfilePostsListResponseProfilePostsItemLinks::fromArray($data['links']) : null,
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\ProfilePostsListResponseProfilePostsItemPermissions::fromArray($data['permissions']) : null,
            timelineUser: isset($data['timeline_user']) && is_array($data['timeline_user']) && !empty($data['timeline_user']) ? \Lolzteam\Generated\Forum\Models\ProfilePostsListResponseProfilePostsItemTimelineUser::fromArray($data['timeline_user']) : null,
        );
    }
