 ...
 * @property-read \Lolzteam\Generated\Forum\Models\ThreadsUnreadResponseDataItemFirstPostLikeUsersItem[]|null $likeUsers Like
 */
class ThreadsUnreadResponseDataItemFirstPost implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsUnreadResponseDataItemFirstPostLinks|null $links = null, // Links
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsUnreadResponseDataItemFirstPostPermissions|null $permissions = null, // Permissions
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            likeUsers: isset($data['like_users']) && is_array($data['like_users']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\ThreadsUnreadResponseDataItemFirstPostLikeUsersItem::fromArray($item), $data['like_users']) : null,
            ...
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\ThreadsUnreadResponseDataItemFirstPostLinks::fromArray($data['links']) : null,
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\ThreadsUnreadResponseDataItemFirstPostPermissions::fromArray($data['permissions']) : null,
        );
    }
