 ...
 * @property-read \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserUserGroupsItem[]|null $userGroups User
 * @property-read \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserFieldsItem[]|null $fields Fields
 * @property-read \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserUserExternalAuthenticationsItem[]|null $userExternalAuthentications User
 */
class ProfilePostsGetResponseProfilePostTimelineUser implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserLinks|null $links = null, // Links
        public readonly \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserPermissions|null $permissions = null, // Permissions
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserSelfPermissions|null $selfPermissions = null, // Self
        public readonly \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserEditPermissions|null $editPermissions = null, // Edit
        public readonly \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserBirthday|null $birthday = null, // Birthday
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserUserFollowing|null $userFollowing = null, // User
        public readonly \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserUserFollowers|null $userFollowers = null, // User
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserLinks::fromArray($data['links']) : null,
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserPermissions::fromArray($data['permissions']) : null,
            ...
            userGroups: isset($data['user_groups']) && is_array($data['user_groups']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserUserGroupsItem::fromArray($item), $data['user_groups']) : null,
            fields: isset($data['fields']) && is_array($data['fields']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserFieldsItem::fromArray($item), $data['fields']) : null,
            userTimezoneOffset: $data['user_timezone_offset'] ?? null,
            userExternalAuthentications: isset($data['user_external_authentications']) && is_array($data['user_external_authentications']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserUserExternalAuthenticationsItem::fromArray($item), $data['user_external_authentications']) : null,
            selfPermissions: isset($data['self_permissions']) && is_array($data['self_permissions']) && !empty($data['self_permissions']) ? \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserSelfPermissions::fromArray($data['self_permissions']) : null,
            editPermissions: isset($data['edit_permissions']) && is_array($data['edit_permissions']) && !empty($data['edit_permissions']) ? \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserEditPermissions::fromArray($data['edit_permissions']) : null,
            birthday: isset($data['birthday']) && is_array($data['birthday']) && !empty($data['birthday']) ? \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserBirthday::fromArray($data['birthday']) : null,
            secretAnswerRendered: $data['secret_answer_rendered'] ?? null,
            secretAnswerFirstLetter: $data['secret_answer_first_letter'] ?? null,
            userFollowing: isset($data['user_following']) && is_array($data['user_following']) && !empty($data['user_following']) ? \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserUserFollowing::fromArray($data['user_following']) : null,
            userFollowers: isset($data['user_followers']) && is_array($data['user_followers']) && !empty($data['user_followers']) ? \Lolzteam\Generated\Forum\Models\ProfilePostsGetResponseProfilePostTimelineUserUserFollowers::fromArray($data['user_followers']) : null,
