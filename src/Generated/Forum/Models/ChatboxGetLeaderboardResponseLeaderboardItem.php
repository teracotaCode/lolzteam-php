 ...
 */
class ChatboxGetLeaderboardResponseLeaderboardItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ChatboxGetLeaderboardResponseLeaderboardItemRendered|null $rendered = null, // Rendered
        public readonly mixed $shortLink = null, // Short
        public readonly int|null $trophyPoints = null, // Trophy
        public readonly \Lolzteam\Generated\Forum\Models\ChatboxGetLeaderboardResponseLeaderboardItemUniqBanner|null $uniqBanner = null, // Uniq
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            rendered: isset($data['rendered']) && is_array($data['rendered']) && !empty($data['rendered']) ? \Lolzteam\Generated\Forum\Models\ChatboxGetLeaderboardResponseLeaderboardItemRendered::fromArray($data['rendered']) : null,
            shortLink: $data['short_link'] ?? null,
            trophyPoints: $data['trophy_points'] ?? null,
            uniqBanner: isset($data['uniq_banner']) && is_array($data['uniq_banner']) && !empty($data['uniq_banner']) ? \Lolzteam\Generated\Forum\Models\ChatboxGetLeaderboardResponseLeaderboardItemUniqBanner::fromArray($data['uniq_banner']) : null,
