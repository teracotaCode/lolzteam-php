 ...
 * @property-read \Lolzteam\Generated\Forum\Models\RespProfilePostModelTimelineUserFieldsItemChoicesItem[]|null $choices Choices
 */
class RespProfilePostModelTimelineUserFieldsItem implements JsonSerializable
{
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            choices: isset($data['choices']) && is_array($data['choices']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\RespProfilePostModelTimelineUserFieldsItemChoicesItem::fromArray($item), $data['choices']) : null,
