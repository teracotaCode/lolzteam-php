 ...
 */
class ChatboxOnlineResponseUsersItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ChatboxOnlineResponseUsersItemRendered|null $rendered = null, // Rendered
        public readonly string|null $shortLink = null, // Short
        public readonly int|null $trophyPoints = null, // Trophy
        public readonly \Lolzteam\Generated\Forum\Models\ChatboxOnlineResponseUsersItemUniqBanner|null $uniqBanner = null, // Uniq
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            rendered: isset($data['rendered']) && is_array($data['rendered']) && !empty($data['rendered']) ? \Lolzteam\Generated\Forum\Models\ChatboxOnlineResponseUsersItemRendered::fromArray($data['rendered']) : null,
            shortLink: $data['short_link'] ?? null,
            trophyPoints: $data['trophy_points'] ?? null,
            uniqBanner: isset($data['uniq_banner']) && is_array($data['uniq_banner']) && !empty($data['uniq_banner']) ? \Lolzteam\Generated\Forum\Models\ChatboxOnlineResponseUsersItemUniqBanner::fromArray($data['uniq_banner']) : null,
