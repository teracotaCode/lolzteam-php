 ...
 */
class ThreadsListResponseThreadsItemContest implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsListResponseThreadsItemContestPermissions|null $permissions = null, // Permissions
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\ThreadsListResponseThreadsItemContestPermissions::fromArray($data['permissions']) : null,
        );
    }
