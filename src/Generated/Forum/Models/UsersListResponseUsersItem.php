 ...
 * @property-read \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemUserGroupsItem[]|null $userGroups User
 * @property-read \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemFieldsItem[]|null $fields Fields
 * @property-read \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemUserExternalAuthenticationsItem[]|null $userExternalAuthentications User
 */
class UsersListResponseUsersItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemLinks|null $links = null, // Links
        public readonly \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemPermissions|null $permissions = null, // Permissions
        ...
        public readonly \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemSelfPermissions|null $selfPermissions = null, // Self
        public readonly \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemEditPermissions|null $editPermissions = null, // Edit
        public readonly \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemBirthday|null $birthday = null, // Birthday
        ...
        public readonly \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemUserFollowing|null $userFollowing = null, // User
        public readonly \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemUserFollowers|null $userFollowers = null, // User
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemLinks::fromArray($data['links']) : null,
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemPermissions::fromArray($data['permissions']) : null,
            ...
            userGroups: isset($data['user_groups']) && is_array($data['user_groups']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemUserGroupsItem::fromArray($item), $data['user_groups']) : null,
            fields: isset($data['fields']) && is_array($data['fields']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemFieldsItem::fromArray($item), $data['fields']) : null,
            userTimezoneOffset: $data['user_timezone_offset'] ?? null,
            userExternalAuthentications: isset($data['user_external_authentications']) && is_array($data['user_external_authentications']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemUserExternalAuthenticationsItem::fromArray($item), $data['user_external_authentications']) : null,
            selfPermissions: isset($data['self_permissions']) && is_array($data['self_permissions']) && !empty($data['self_permissions']) ? \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemSelfPermissions::fromArray($data['self_permissions']) : null,
            editPermissions: isset($data['edit_permissions']) && is_array($data['edit_permissions']) && !empty($data['edit_permissions']) ? \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemEditPermissions::fromArray($data['edit_permissions']) : null,
            birthday: isset($data['birthday']) && is_array($data['birthday']) && !empty($data['birthday']) ? \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemBirthday::fromArray($data['birthday']) : null,
            secretAnswerRendered: $data['secret_answer_rendered'] ?? null,
            secretAnswerFirstLetter: $data['secret_answer_first_letter'] ?? null,
            userFollowing: isset($data['user_following']) && is_array($data['user_following']) && !empty($data['user_following']) ? \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemUserFollowing::fromArray($data['user_following']) : null,
            userFollowers: isset($data['user_followers']) && is_array($data['user_followers']) && !empty($data['user_followers']) ? \Lolzteam\Generated\Forum\Models\UsersListResponseUsersItemUserFollowers::fromArray($data['user_followers']) : null,
