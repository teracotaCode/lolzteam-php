 ...
 */
class ThreadsGetResponseThreadLastPost implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsGetResponseThreadLastPostLinks|null $links = null, // Links
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsGetResponseThreadLastPostPermissions|null $permissions = null, // Permissions
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\ThreadsGetResponseThreadLastPostLinks::fromArray($data['links']) : null,
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\ThreadsGetResponseThreadLastPostPermissions::fromArray($data['permissions']) : null,
