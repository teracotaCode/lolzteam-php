 ...
 */
class ThreadsEditResponseThreadFirstPost implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsEditResponseThreadFirstPostLinks|null $links = null, // Links
        public readonly \Lolzteam\Generated\Forum\Models\ThreadsEditResponseThreadFirstPostPermissions|null $permissions = null, // Permissions
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\ThreadsEditResponseThreadFirstPostLinks::fromArray($data['links']) : null,
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\ThreadsEditResponseThreadFirstPostPermissions::fromArray($data['permissions']) : null,
