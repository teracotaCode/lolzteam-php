 ...
 * @property-read \Lolzteam\Generated\Forum\Models\ConversationsMessagesEditResponseMessageRecipientsItem[]|null $recipients Recipients
 */
class ConversationsMessagesEditResponseMessage implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ConversationsMessagesEditResponseMessagePermissions|null $permissions = null, // Permissions
        ...
        public readonly \Lolzteam\Generated\Forum\Models\ConversationsMessagesEditResponseMessageRecipient|null $recipient = null, // Recipient
        public readonly array|null $recipients = null, // Recipients
        public readonly \Lolzteam\Generated\Forum\Models\ConversationsMessagesEditResponseMessageLinks|null $links = null, // Links
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\ConversationsMessagesEditResponseMessagePermissions::fromArray($data['permissions']) : null,
            ...
            recipient: isset($data['recipient']) && is_array($data['recipient']) && !empty($data['recipient']) ? \Lolzteam\Generated\Forum\Models\ConversationsMessagesEditResponseMessageRecipient::fromArray($data['recipient']) : null,
            recipients: isset($data['recipients']) && is_array($data['recipients']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\ConversationsMessagesEditResponseMessageRecipientsItem::fromArray($item), $data['recipients']) : null,
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\ConversationsMessagesEditResponseMessageLinks::fromArray($data['links']) : null,
        );
    }
