 ...
 * @property-read \Lolzteam\Generated\Forum\Models\SearchTaggedResponseDataItemForumForumPrefixesItem[]|null $forumPrefixes Forum
 */
class SearchTaggedResponseDataItemForum implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\SearchTaggedResponseDataItemForumLinks|null $links = null, // Links
        public readonly \Lolzteam\Generated\Forum\Models\SearchTaggedResponseDataItemForumPermissions|null $permissions = null, // Permissions
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            forumPrefixes: isset($data['forum_prefixes']) && is_array($data['forum_prefixes']) ? array_map(static fn(array $item) => \Lolzteam\Generated\Forum\Models\SearchTaggedResponseDataItemForumForumPrefixesItem::fromArray($item), $data['forum_prefixes']) : null,
            threadDefaultPrefixId: $data['thread_default_prefix_id'] ?? null,
            threadPrefixIsRequired: $data['thread_prefix_is_required'] ?? null,
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\SearchTaggedResponseDataItemForumLinks::fromArray($data['links']) : null,
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\SearchTaggedResponseDataItemForumPermissions::fromArray($data['permissions']) : null,
