 ...
 */
class UsersFollowingsResponseUsersItem implements JsonSerializable
{
    public function __construct(
        ...
        public readonly \Lolzteam\Generated\Forum\Models\UsersFollowingsResponseUsersItemLinks|null $links = null, // Links
        public readonly \Lolzteam\Generated\Forum\Models\UsersFollowingsResponseUsersItemPermissions|null $permissions = null, // Permissions
        ...
        public readonly \Lolzteam\Generated\Forum\Models\UsersFollowingsResponseUsersItemCustomFields|null $customFields = null, // Custom
    ) {}
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            links: isset($data['links']) && is_array($data['links']) && !empty($data['links']) ? \Lolzteam\Generated\Forum\Models\UsersFollowingsResponseUsersItemLinks::fromArray($data['links']) : null,
            permissions: isset($data['permissions']) && is_array($data['permissions']) && !empty($data['permissions']) ? \Lolzteam\Generated\Forum\Models\UsersFollowingsResponseUsersItemPermissions::fromArray($data['permissions']) : null,
            userIsIgnored: $data['user_is_ignored'] ?? null,
            userIsVisitor: $data['user_is_visitor'] ?? null,
            userGroupId: $data['user_group_id'] ?? null,
            customFields: isset($data['custom_fields']) && is_array($data['custom_fields']) && !empty($data['custom_fields']) ? \Lolzteam\Generated\Forum\Models\UsersFollowingsResponseUsersItemCustomFields::fromArray($data['custom_fields']) : null,
        );
    }
